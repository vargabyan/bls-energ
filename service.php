                    ...
                    <?php foreach ($images as $key => $image) { ?>
                        <div class="swiper-slide">
                            <div class="swiper-slide-item">
                                <a href="<?= $image ?>" data-fancybox="service-gallery-<?= $image ?>" data-caption="image">
...
<section class="core-container page-layout">
    ...
    <div class="page-layout_container">
        <div class="about-services">
            <span class="about-services_title">об услуге</span>
        ...
        <div class="projects_header-wrapper">
            ...
            <a class="project_btn-show-more" href="/services.php">Смотреть все проекты</a>
        </div>
...
<div class="core-container services">
    ...
    <a class="services-and-product-wrapper_btn-show-more" href="">Смотреть все Услуги</a>
</div>
